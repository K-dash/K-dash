...
<div align=center>
  <a href="https://github.com/ryo-ma/github-profile-trophy" title="Go to Source">
      <img align="center" width=84% src="https://github-profile-trophy.vercel.app/?username=K-dash&theme=radical&row=1&column=7&margin-h=15&margin-w=5&no-bg=true" alt="TROPHY" />
    </a>
</div>
<!--- trophy (start) -->
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,django,fastapi,flask,git,github,githubactions,bitbucket,powershell,sqlite,postgresql,mysql,gmail,ruby,redhat,aws,azure,ubuntu,debian,bash,vim,windows,bootstrap,elasticsearch,cs,dotnet,css,discord,docker,postgres,redis,github,html,java,js,linux,md,nginx,mysql,nodejs,ts,vscode,kubernetes,graphql,obsidian,&perline=14" />
  </a>
</p>
